...
export class SearchpageComponent implements OnInit {
  ...
  getCategory(){
    ...
    this.apollo.query<{filtergamebyCommunityRec:any}>({
      ...
      this.genrelist = res.data?.filtergamebyCommunityRec;
    });
  ...
  init(kw:string, countGame: number){
    ...
    this.apollo.query<{searchGamePage:any}>({
      query:gql`query searchGamePage($keyword:String!, $countGame:Int!){
        searchGamePage(keyword:$keyword, countGame:$countGame){
          id
          name
          banner
          price
      ...
      }`, variables: {keyword: kw, countGame: countGame}
    }).subscribe(res=>{
      this.gameresult = res.data?.searchGamePage;
  ...
  filterbyPrice(price:number){
    ...
    console.log(this.kw);
    this.apollo.query<{filtergameByPrice:any}>({
      query:gql`query filtergameByPrice($price:Int!, $keyword:String!, $countGame:Int!){
        filtergameByPrice(price: $price, keyword:$keyword, countGame:$countGame){
          id
          name
          banner
          price
      ...
      }`, variables: {price: price, keyword: this.kw, countGame: this.countgame}
    }).subscribe(res=>{
      this.gameresult = res.data?.filtergameByPrice;
    })
  }
